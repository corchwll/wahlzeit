...
public class SysConfig extends AbstractConfig {
	...
	public SysConfig(String myRootDir) {
		...
		doSetValue(SysConfig.DB_CONNECTION, "jdbc:postgresql://localhost:5432/fertig");
		doSetValue(SysConfig.DB_USER, "fertig");
		doSetValue(SysConfig.DB_PASSWORD, "rBzDVFzsEMkzmPXF");
	}
